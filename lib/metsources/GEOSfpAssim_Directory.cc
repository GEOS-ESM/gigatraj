...
GEOSfpAssim_Directory::MVarLoc::MVarLoc(const std::string Baseurl, const std::string Categ, const std::string Tag, const int Hgrid, const int Vcoord, const int Tspace, const int Tavg, const int Tbase )
{
     baseurl = Baseurl;
     categ = Categ;
     tag = Tag;
...
GEOSfpAssim_Directory::MVarLoc::~MVarLoc()
{

}

GEOSfpAssim_Directory::MVarDesc::MVarDesc(const std::string Quantity, const int Ndims, const std::string Stdname, const std::string Longname, const std::string Units, const std::string loclist )
{
     char locsep = '|';
     char partsep = ',';
     size_t grppos;
...
GEOSfpAssim_Directory::MVarDesc::~MVarDesc()
{
...
#include "GEOSfpAssim_Directory_Data.hh"
...
std::string GEOSfpAssim_Directory::CFName(const std::string &geosName ) const
{     
     try {
...
std::string GEOSfpAssim_Directory::GEOSfpAssimName(const std::string &cfName ) const
{
     try {
...
int GEOSfpAssim_Directory::LookUp(const std::string geosName
