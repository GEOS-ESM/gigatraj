...
class MetMERRA : public MetGEOSPortal {
   ...
   protected:
      ...
      */
       ...
       */
       ...
       /// creates a new MetMERRA object
       /*! This method  duplicates the current object,
           creating a new MetMERRA object
      ...
      */
      GridLatLonFieldSfc* new_directGridSfc( const std::string quantity, const std::string time );
       ...
       /// Object for finding MERRA data
       static const gigatraj::MERRA_Directory dir;
