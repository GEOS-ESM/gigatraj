...
/*!
\ingroup MetSrc
\brief class for reading the NASA GMAO GEOSfpFcast data product.
...
in the MERRA2 system and hence in the MetGEOSfpFcast class. The cf-standard names
...
class MetGEOSfpFcast : public MetMyGEOS {
   ...
   public:
      ...
      /*! In this version of the constructor, the base date is specified that is equivalent to internal model time zero
       is explicitly given
          ...
          \param date a string containing a date in ISO8601 format (e.g., "2005-04-25")
                      ...
                      will be referenced.
      */
      MetGEOSfpFcast( std::string& date );                
      ...
      */
      MetGEOSfpFcast( const MetGEOSfpFcast& src );

      /// assignment operator
      MetGEOSfpFcast& operator=(const MetGEOSfpFcast& src);
   ...
   protected:
       ...
       */    
       void assign( const MetGEOSfpFcast& src );
